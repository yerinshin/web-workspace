         ...
         <div id="main_slider" class="carousel slide banner-main" data-ride="carousel">
            ...
            <div class="carousel-inner">
               <div class="carousel-item active">
                  <img class="first-slide" src="<%= request.getContextPath() %>/resources/images/banner4.png" alt="First slide">
                  <div class="container">
         ...
         <div class="container">
            ...
            <div class="row">
               <ul class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="for_box">
                     <i><img src="<%= request.getContextPath() %>/resources/icon/1.png"/></i>
                     <h3>Data recovery</h3>
               ...
               <ul class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="for_box">
                     <i><img src="<%= request.getContextPath() %>/resources/icon/2.png"/></i>
               ...
               <ul class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="for_box">
                     <i><img src="<%= request.getContextPath() %>/resources/icon/3.png"/></i>
               ...
               <ul class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="for_box">
                     <i><img src="<%= request.getContextPath() %>/resources/icon/4.png"/></i>
...
<!-- end CHOOSE -->
            ...
            <div class="row">
               <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                  <div class="service-box">
                     <i><img src="<%= request.getContextPath() %>/resources/icon/service1.png"/></i>
                     <h3>Fast service</h3>
               ...
               <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                  <div class="service-box">
                     <i><img src="<%= request.getContextPath() %>/resources/icon/service2.png"/></i>
               ...
               <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                  <div class="service-box">
                     <i><img src="<%= request.getContextPath() %>/resources/icon/service3.png"/></i>
                     <h3>Expert team</h3>
                     <p>Exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea </p>
                  </div>
               </div>
               <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                  <div class="service-box">
                     <i><img src="<%= request.getContextPath() %>/resources/icon/service4.png"/></i>
               ...
               <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                  <div class="service-box">
                     <i><img src="<%= request.getContextPath() %>/resources/icon/service5.png"/></i>
               ...
               <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12">
                  <div class="service-box">
                     <i><img src="<%= request.getContextPath() %>/resources/icon/service6.png"/></i>
                     <h3>Award winning</h3>
                     <p>Exerci tation ullamcorper suscipit lobortis nisl ut aliquip ex ea </p>
                  </div>
               </div>
            ...
            <div class="row">
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="<%= request.getContextPath() %>/resources/icon/p1.png"/></i>
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="<%= request.getContextPath() %>/resources/icon/p2.png"/></i>
                     <h3>Norton Internet Security</h3>
                     <span>$25.00</span>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="<%= request.getContextPath() %>/resources/icon/p3.png"/></i>
                     <h3>Norton Internet Security</h3>
                     <span>$25.00</span>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="<%= request.getContextPath() %>/resources/icon/p4.png"/></i>
                     <h3>Norton Internet Security</h3>
                     <span>$25.00</span>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="<%= request.getContextPath() %>/resources/icon/p5.png"/></i>
                     <h3>Norton Internet Security</h3>
                     <span>$25.00</span>
                  </div>
               </div>
               ...
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="<%= request.getContextPath() %>/resources/icon/p6.png"/></i>
                     <h3>Norton Internet Security</h3>
                     <span>$25.00</span>
                  </div>
               </div>
               <div class="col-xl-3 col-lg-3 col-md-6 col-sm-12">
                  <div class="product-box">
                     <i><img src="<%= request.getContextPath() %>/resources/icon/p7.png"/></i>
                     <h3>Norton Internet Security</h3>
                     <span>$25.00</span>
                  </div>
               </div>
          ...
          <div class="carousel-item active">
            <div class="container">
              <div class="carousel-caption text-bg">
               <div class="img_bg">
                  <i><img src="<%= request.getContextPath() %>/resources/images/lllll.png"/><span>Jone Due<br><strong class="date">12/02/2019</strong></span></i>
            ...
            <div class="row">
               <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12">
                  <div class="yellow-box">
                     <h3>REQUEST A FREE QUOTE<i><img src="<%= request.getContextPath() %>/resources/icon/calll.png"/></i></h3>
      ...
      <div class="container-fluid padi">
         <div class="map">
            <img src="<%= request.getContextPath() %>/resources/images/mapimg.jpg" alt="img"/>
         </div>
      </div>
      <!-- end map --> 
      <!--  footer --> 
